/**
 * Automatic Project Health Calculation Engine
 * Analyzes progress, open problems, critical problems, overdue tasks, and risk severity.
 */
...
export function calculateProjectHealth({
  ...
  // Deductions based on risks & critical problems
